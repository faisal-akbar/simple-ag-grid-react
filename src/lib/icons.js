...
export const icons = {
    ...
    groupExpanded:
        '<i class="fa fa-minus-square" style="height: 12px; width: 12px;padding-right: 2px"/>',
    groupContracted:
        '<i class="fa fa-plus-square" style="height: 12px; width: 12px;padding-right: 2px"/>',
    ...
    rowGroupPanel: '<i class="fas fa-layer-group"/>',
