...
const MySQLNivo = () => {
    ...
    // Integration with the Nivo Chart by Click on row and get some query parameter and pass to api
        ...
        const result = [
            {
                ...
                disabled: !(segmentQueryParam && regionQueryParam && categoryQueryParam),
                cssClasses: ['text-green-500', 'font-bold'],
                tooltip: 'Sales Trend for Segment, Region and Category. Please check it.',
            },
        ...
        >
            ...
            <AgGridReact
                ...
                onCellClicked={(params) => {
                    const { segment, region, category } = params.data;
                    setSegmentQueryParam(segment);
